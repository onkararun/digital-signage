				...
				<div id="slide-general-settings-content" style="<?php echo (!$slide->isStaticSlide()) ? ' display:none' : ''; ?>">
					...
					?>
						...
						<p>
						 ...
						 <p>
							<?php $hr1 = RevSliderFunctions::getVal($slideParams, 'hr1',''); ?>
                            ...
                            <?php $min1 = RevSliderFunctions::getVal($slideParams, 'min1',''); ?>
						...
						<!--Custom field for Time to-->
						 <p>
							<?php $hr2 = RevSliderFunctions::getVal($slideParams, 'hr2',''); ?>
                            ...
                            <?php $min2 = RevSliderFunctions::getVal($slideParams, 'min2',''); ?>
						...
						<p>
							<?php $date = RevSliderFunctions::getVal($slideParams, 'date',''); ?>
